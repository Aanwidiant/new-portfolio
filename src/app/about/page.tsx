        ...
        <div className="container text-justify">
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <h4 className="mb-5 text-2xl font-bold text-dark dark:text-light lg:text-2xl">Misi saya.</h4>
              <p className="mb-5 text-base font-medium text-dark-etd dark:text-light-etd lg:text-lg">Untuk terus belajar dan berkembang di dunia teknologi, serta berkontribusi pada pengembangan solusi web yang efektif dan efisien yang dapat mendukung kebutuhan pengguna dan bisnis.</p>
            </div>
          </div>
          <div className="px-4">
            <h4 className="mb-5 text-2xl font-bold text-dark dark:text-light lg:text-2xl">Motivasi saya:</h4>
            <p className="mb-5 text-base font-medium text-dark-etd dark:text-light-etd lg:text-lg">Saya termotivasi oleh tantangan untuk mengatasi masalah melalui pengembangan web dan percaya bahwa teknologi memiliki potensi besar untuk membawa perubahan positif dalam kehidupan banyak orang. Saya berusaha keras untuk selalu meningkatkan keterampilan saya dan siap untuk beradaptasi dengan teknologi terbaru.</p>
          </div>
        </div>
      </section>
      <section>
        <div className="container text-justify">
          <div className="flex flex-wrap">
            <h2 className="w-full mb-6 text-3xl font-bold text-center text-dark dark:text-light lg:text-4xl">My <span
